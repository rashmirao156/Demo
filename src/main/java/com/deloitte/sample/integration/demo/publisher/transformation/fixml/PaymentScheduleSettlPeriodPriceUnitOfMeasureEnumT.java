...
/**
 * <p>Java class for PaymentScheduleSettlPeriodPriceUnitOfMeasure_enum_t.
 * 
...
public enum PaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT {
    ...
    public static PaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT fromValue(String v) {
        for (PaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT c: PaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
