...
/**
 * <p>Java class for UnderlyingDeliveryScheduleNotionalUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingDeliveryScheduleNotionalUnitOfMeasureEnumT {
    ...
    public static UnderlyingDeliveryScheduleNotionalUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingDeliveryScheduleNotionalUnitOfMeasureEnumT c: UnderlyingDeliveryScheduleNotionalUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
