...
/**
 * <p>Java class for UnderlyingPaymentScheduleRateUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingPaymentScheduleRateUnitOfMeasureEnumT {
    ...
    public static UnderlyingPaymentScheduleRateUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingPaymentScheduleRateUnitOfMeasureEnumT c: UnderlyingPaymentScheduleRateUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
