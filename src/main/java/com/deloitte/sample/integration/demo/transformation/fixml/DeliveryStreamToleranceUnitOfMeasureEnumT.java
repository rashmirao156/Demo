...
/**
 * <p>Java class for DeliveryStreamToleranceUnitOfMeasure_enum_t.
 * 
...
public enum DeliveryStreamToleranceUnitOfMeasureEnumT {
    ...
    public static DeliveryStreamToleranceUnitOfMeasureEnumT fromValue(String v) {
        for (DeliveryStreamToleranceUnitOfMeasureEnumT c: DeliveryStreamToleranceUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
