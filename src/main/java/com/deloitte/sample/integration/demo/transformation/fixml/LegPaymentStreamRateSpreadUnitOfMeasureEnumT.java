...
/**
 * <p>Java class for LegPaymentStreamRateSpreadUnitOfMeasure_enum_t.
 * 
...
public enum LegPaymentStreamRateSpreadUnitOfMeasureEnumT {
    ...
    public static LegPaymentStreamRateSpreadUnitOfMeasureEnumT fromValue(String v) {
        for (LegPaymentStreamRateSpreadUnitOfMeasureEnumT c: LegPaymentStreamRateSpreadUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
