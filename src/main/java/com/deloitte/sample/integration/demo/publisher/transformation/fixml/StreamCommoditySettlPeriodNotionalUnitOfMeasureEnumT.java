...
/**
 * <p>Java class for StreamCommoditySettlPeriodNotionalUnitOfMeasure_enum_t.
 * 
...
public enum StreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT {
    ...
    public static StreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT fromValue(String v) {
        for (StreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT c: StreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
