...
/**
 * <p>Java class for StreamCommoditySettlPeriodPriceUnitOfMeasure_enum_t.
 * 
...
public enum StreamCommoditySettlPeriodPriceUnitOfMeasureEnumT {
    ...
    public static StreamCommoditySettlPeriodPriceUnitOfMeasureEnumT fromValue(String v) {
        for (StreamCommoditySettlPeriodPriceUnitOfMeasureEnumT c: StreamCommoditySettlPeriodPriceUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
