...
/**
 * <p>Java class for PaymentStreamFixedAmountUnitOfMeasure_enum_t.
 * 
...
public enum PaymentStreamFixedAmountUnitOfMeasureEnumT {
    ...
    public static PaymentStreamFixedAmountUnitOfMeasureEnumT fromValue(String v) {
        for (PaymentStreamFixedAmountUnitOfMeasureEnumT c: PaymentStreamFixedAmountUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
