...
/**
 * <p>Java class for UnderlyingPaymentStreamNonDeliverableSettlTerms_Block_t complex type.
 * 
...
@XmlType(name = "UnderlyingPaymentStreamNonDeliverableSettlTerms_Block_t", propOrder = {
    "bizCtr",
    "rtSrc",
    "fixngDt",
    "settlRtFallbck"
...
public class UnderlyingPaymentStreamNonDeliverableSettlTermsBlockT {
     ...
     * {@link UnderlyingPaymentStreamNonDeliverableFixingDatesBusinessCenterGrpBlockT }
     * 
     * 
     */
    public List<UnderlyingPaymentStreamNonDeliverableFixingDatesBusinessCenterGrpBlockT> getBizCtr() {
        if (bizCtr == null) {
            bizCtr = new ArrayList<UnderlyingPaymentStreamNonDeliverableFixingDatesBusinessCenterGrpBlockT>();
        }
        return this.bizCtr;
    }
     ...
     * @return
     *     possible object is
     *     {@link UnderlyingPaymentStreamNonDeliverableSettlRateSourceBlockT }
     *     
     */
     ...
     * @return
     *     possible object is
     *     {@link UnderlyingPaymentStreamNonDeliverableFixingDateGrpBlockT }
     *     
     */
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the settlRtFallbck property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link UnderlyingSettlRateDisruptionFallbackGrpBlockT }
     * 
     * 
     */
