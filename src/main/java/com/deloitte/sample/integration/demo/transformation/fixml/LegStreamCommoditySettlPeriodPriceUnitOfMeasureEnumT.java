...
/**
 * <p>Java class for LegStreamCommoditySettlPeriodPriceUnitOfMeasure_enum_t.
 * 
...
public enum LegStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT {
    ...
    public static LegStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT fromValue(String v) {
        for (LegStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT c: LegStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
