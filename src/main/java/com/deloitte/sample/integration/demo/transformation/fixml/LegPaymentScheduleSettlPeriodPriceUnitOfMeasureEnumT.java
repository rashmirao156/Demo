...
/**
 * <p>Java class for LegPaymentScheduleSettlPeriodPriceUnitOfMeasure_enum_t.
 * 
...
public enum LegPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT {
    ...
    public static LegPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT fromValue(String v) {
        for (LegPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT c: LegPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
