...
/**
 * <p>Java class for UnderlyingPaymentScheduleStepUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingPaymentScheduleStepUnitOfMeasureEnumT {
    ...
    public static UnderlyingPaymentScheduleStepUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingPaymentScheduleStepUnitOfMeasureEnumT c: UnderlyingPaymentScheduleStepUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
