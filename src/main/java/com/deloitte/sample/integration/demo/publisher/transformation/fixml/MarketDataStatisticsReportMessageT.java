...
@XmlType(name = "MarketDataStatisticsReport_message_t", propOrder = {
    "applSeqCtrl",
    "pty",
    "instrmt",
    "instrmtExt",
...
public class MarketDataStatisticsReportMessageT
    extends AbstractMessageT
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statsRpt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
