...
/**
 * <p>Java class for LegDeliveryScheduleNotionalUnitOfMeasure_enum_t.
 * 
...
public enum LegDeliveryScheduleNotionalUnitOfMeasureEnumT {
    ...
    public static LegDeliveryScheduleNotionalUnitOfMeasureEnumT fromValue(String v) {
        for (LegDeliveryScheduleNotionalUnitOfMeasureEnumT c: LegDeliveryScheduleNotionalUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
