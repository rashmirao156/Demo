...
/**
 * <p>Java class for UnderlyingPaymentStreamRateIndexUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingPaymentStreamRateIndexUnitOfMeasureEnumT {
    ...
    public static UnderlyingPaymentStreamRateIndexUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingPaymentStreamRateIndexUnitOfMeasureEnumT c: UnderlyingPaymentStreamRateIndexUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
