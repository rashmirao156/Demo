...
/**
 * <p>Java class for UnderlyingStreamCommodityUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingStreamCommodityUnitOfMeasureEnumT {
    ...
    public static UnderlyingStreamCommodityUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingStreamCommodityUnitOfMeasureEnumT c: UnderlyingStreamCommodityUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
