...
/**
 * <p>Java class for UnderlyingStreamCommoditySettlPeriodPriceUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT {
    ...
    public static UnderlyingStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT c: UnderlyingStreamCommoditySettlPeriodPriceUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
