...
/**
 * <p>Java class for LegPaymentStreamRateIndexUnitOfMeasure_enum_t.
 * 
...
public enum LegPaymentStreamRateIndexUnitOfMeasureEnumT {
    ...
    public static LegPaymentStreamRateIndexUnitOfMeasureEnumT fromValue(String v) {
        for (LegPaymentStreamRateIndexUnitOfMeasureEnumT c: LegPaymentStreamRateIndexUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
