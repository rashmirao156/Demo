...
/**
 * <p>Java class for UnderlyingDeliveryStreamToleranceUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingDeliveryStreamToleranceUnitOfMeasureEnumT {
    ...
    public static UnderlyingDeliveryStreamToleranceUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingDeliveryStreamToleranceUnitOfMeasureEnumT c: UnderlyingDeliveryStreamToleranceUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
