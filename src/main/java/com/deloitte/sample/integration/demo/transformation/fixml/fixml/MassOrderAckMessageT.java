...
import com.deloitte.sample.integration.demo.transformation.fixml.ThrottleResponseBlockT;
...
@XmlType(name = "MassOrderAck_message_t", propOrder = {
    "applSeqCtrl",
    "pty",
    "thrttlRsp",
    "orderEntryAck"
})
public class MassOrderAckMessageT
    extends AbstractMessageT
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the orderEntryAck property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
