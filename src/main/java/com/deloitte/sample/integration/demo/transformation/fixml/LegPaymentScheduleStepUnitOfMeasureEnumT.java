...
/**
 * <p>Java class for LegPaymentScheduleStepUnitOfMeasure_enum_t.
 * 
...
public enum LegPaymentScheduleStepUnitOfMeasureEnumT {
    ...
    public static LegPaymentScheduleStepUnitOfMeasureEnumT fromValue(String v) {
        for (LegPaymentScheduleStepUnitOfMeasureEnumT c: LegPaymentScheduleStepUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
