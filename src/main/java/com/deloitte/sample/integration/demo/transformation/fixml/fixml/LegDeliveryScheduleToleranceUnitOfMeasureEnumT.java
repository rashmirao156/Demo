...
/**
 * <p>Java class for LegDeliveryScheduleToleranceUnitOfMeasure_enum_t.
 * 
...
public enum LegDeliveryScheduleToleranceUnitOfMeasureEnumT {
    ...
    public static LegDeliveryScheduleToleranceUnitOfMeasureEnumT fromValue(String v) {
        for (LegDeliveryScheduleToleranceUnitOfMeasureEnumT c: LegDeliveryScheduleToleranceUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
