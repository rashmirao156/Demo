...
/**
 * <p>Java class for LegPaymentStreamReferenceLevelUnitOfMeasure_enum_t.
 * 
...
public enum LegPaymentStreamReferenceLevelUnitOfMeasureEnumT {
    ...
    public static LegPaymentStreamReferenceLevelUnitOfMeasureEnumT fromValue(String v) {
        for (LegPaymentStreamReferenceLevelUnitOfMeasureEnumT c: LegPaymentStreamReferenceLevelUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
