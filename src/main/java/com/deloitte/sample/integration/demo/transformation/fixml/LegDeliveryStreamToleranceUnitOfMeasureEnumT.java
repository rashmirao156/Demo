...
/**
 * <p>Java class for LegDeliveryStreamToleranceUnitOfMeasure_enum_t.
 * 
...
public enum LegDeliveryStreamToleranceUnitOfMeasureEnumT {
    ...
    public static LegDeliveryStreamToleranceUnitOfMeasureEnumT fromValue(String v) {
        for (LegDeliveryStreamToleranceUnitOfMeasureEnumT c: LegDeliveryStreamToleranceUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
