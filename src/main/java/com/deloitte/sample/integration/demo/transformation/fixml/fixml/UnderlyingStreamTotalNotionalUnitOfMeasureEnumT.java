...
/**
 * <p>Java class for UnderlyingStreamTotalNotionalUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingStreamTotalNotionalUnitOfMeasureEnumT {
    ...
    public static UnderlyingStreamTotalNotionalUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingStreamTotalNotionalUnitOfMeasureEnumT c: UnderlyingStreamTotalNotionalUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
