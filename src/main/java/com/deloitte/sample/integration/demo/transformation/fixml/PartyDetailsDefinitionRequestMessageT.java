...
@XmlType(name = "PartyDetailsDefinitionRequest_message_t", propOrder = {
    "reqPty",
    "ptyDetlUpd"
})
public class PartyDetailsDefinitionRequestMessageT
    extends AbstractMessageT
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ptyDetlUpd property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartyDetailsUpdateGrpBlockT }
     * 
     * 
     */
