...
/**
 * <p>Java class for LegStreamCommoditySettlPeriodNotionalUnitOfMeasure_enum_t.
 * 
...
public enum LegStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT {
    ...
    public static LegStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT fromValue(String v) {
        for (LegStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT c: LegStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
