...
/**
 * <p>Java class for PaymentStreamRateSpreadUnitOfMeasure_enum_t.
 * 
...
public enum PaymentStreamRateSpreadUnitOfMeasureEnumT {
    ...
    public static PaymentStreamRateSpreadUnitOfMeasureEnumT fromValue(String v) {
        for (PaymentStreamRateSpreadUnitOfMeasureEnumT c: PaymentStreamRateSpreadUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
