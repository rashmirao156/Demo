...
/**
 * <p>Java class for DeliveryScheduleToleranceUnitOfMeasure_enum_t.
 * 
...
public enum DeliveryScheduleToleranceUnitOfMeasureEnumT {
    ...
    public static DeliveryScheduleToleranceUnitOfMeasureEnumT fromValue(String v) {
        for (DeliveryScheduleToleranceUnitOfMeasureEnumT c: DeliveryScheduleToleranceUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
