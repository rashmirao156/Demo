...
/**
 * <p>Java class for PaymentStreamRateIndexUnitOfMeasure_enum_t.
 * 
...
public enum PaymentStreamRateIndexUnitOfMeasureEnumT {
    ...
    public static PaymentStreamRateIndexUnitOfMeasureEnumT fromValue(String v) {
        for (PaymentStreamRateIndexUnitOfMeasureEnumT c: PaymentStreamRateIndexUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
