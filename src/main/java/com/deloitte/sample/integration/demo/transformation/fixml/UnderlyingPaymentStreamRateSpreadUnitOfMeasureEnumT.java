...
/**
 * <p>Java class for UnderlyingPaymentStreamRateSpreadUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingPaymentStreamRateSpreadUnitOfMeasureEnumT {
    ...
    public static UnderlyingPaymentStreamRateSpreadUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingPaymentStreamRateSpreadUnitOfMeasureEnumT c: UnderlyingPaymentStreamRateSpreadUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
