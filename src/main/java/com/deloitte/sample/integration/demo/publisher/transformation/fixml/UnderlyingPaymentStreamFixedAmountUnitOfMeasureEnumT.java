...
/**
 * <p>Java class for UnderlyingPaymentStreamFixedAmountUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingPaymentStreamFixedAmountUnitOfMeasureEnumT {
    ...
    public static UnderlyingPaymentStreamFixedAmountUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingPaymentStreamFixedAmountUnitOfMeasureEnumT c: UnderlyingPaymentStreamFixedAmountUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
