...
/**
 * <p>Java class for TrdMatchSideGrp_Block_t complex type.
 * 
...
@XmlType(name = "TrdMatchSideGrp_Block_t", propOrder = {
    "pty",
    "alloc",
    "trdRptOrdDetl",
    "legExec"
...
public class TrdMatchSideGrpBlockT {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the legExec property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TrdInstrmtLegExecGrpBlockT }
     * 
     * 
     */
