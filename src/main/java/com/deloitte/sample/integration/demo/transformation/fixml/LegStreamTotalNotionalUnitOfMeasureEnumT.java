...
/**
 * <p>Java class for LegStreamTotalNotionalUnitOfMeasure_enum_t.
 * 
...
public enum LegStreamTotalNotionalUnitOfMeasureEnumT {
    ...
    public static LegStreamTotalNotionalUnitOfMeasureEnumT fromValue(String v) {
        for (LegStreamTotalNotionalUnitOfMeasureEnumT c: LegStreamTotalNotionalUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
