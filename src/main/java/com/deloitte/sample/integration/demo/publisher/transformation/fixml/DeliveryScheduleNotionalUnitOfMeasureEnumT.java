...
/**
 * <p>Java class for DeliveryScheduleNotionalUnitOfMeasure_enum_t.
 * 
...
public enum DeliveryScheduleNotionalUnitOfMeasureEnumT {
    ...
    public static DeliveryScheduleNotionalUnitOfMeasureEnumT fromValue(String v) {
        for (DeliveryScheduleNotionalUnitOfMeasureEnumT c: DeliveryScheduleNotionalUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
