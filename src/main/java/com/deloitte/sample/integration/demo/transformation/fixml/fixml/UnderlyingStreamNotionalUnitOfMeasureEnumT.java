...
/**
 * <p>Java class for UnderlyingStreamNotionalUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingStreamNotionalUnitOfMeasureEnumT {
    ...
    public static UnderlyingStreamNotionalUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingStreamNotionalUnitOfMeasureEnumT c: UnderlyingStreamNotionalUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
