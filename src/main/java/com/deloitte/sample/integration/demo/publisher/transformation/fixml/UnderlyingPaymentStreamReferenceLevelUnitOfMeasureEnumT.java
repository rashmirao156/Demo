...
/**
 * <p>Java class for UnderlyingPaymentStreamReferenceLevelUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingPaymentStreamReferenceLevelUnitOfMeasureEnumT {
    ...
    public static UnderlyingPaymentStreamReferenceLevelUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingPaymentStreamReferenceLevelUnitOfMeasureEnumT c: UnderlyingPaymentStreamReferenceLevelUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
