...
/**
 * <p>Java class for UnderlyingStreamCommoditySettlPeriodNotionalUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT {
    ...
    public static UnderlyingStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT c: UnderlyingStreamCommoditySettlPeriodNotionalUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
