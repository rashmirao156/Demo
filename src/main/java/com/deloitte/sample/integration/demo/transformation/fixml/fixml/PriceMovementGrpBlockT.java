...
/**
 * <p>Java class for PriceMovementGrp_Block_t complex type.
 * 
...
@XmlType(name = "PriceMovementGrp_Block_t", propOrder = {
    "pxMvmntValu",
    "clrAcctTyp"
})
public class PriceMovementGrpBlockT {
     ...
     * This is why there is not a <CODE>set</CODE> method for the pxMvmntValu property.
     * 
     * <p>
     ...
     * {@link PriceMovementValueGrpBlockT }
     * 
     * 
     */
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the clrAcctTyp property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ClearingAccountTypeGrpBlockT }
     * 
     * 
     */
