...
/**
 * <p>Java class for UnderlyingDeliveryScheduleToleranceUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingDeliveryScheduleToleranceUnitOfMeasureEnumT {
    ...
    public static UnderlyingDeliveryScheduleToleranceUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingDeliveryScheduleToleranceUnitOfMeasureEnumT c: UnderlyingDeliveryScheduleToleranceUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
