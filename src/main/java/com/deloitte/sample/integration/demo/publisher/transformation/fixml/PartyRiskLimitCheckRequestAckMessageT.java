...
/**
 * PartyRiskLimitCheckRequestAck can be found in Volume 3 of the
 * 						specification
 * 
...
@XmlType(name = "PartyRiskLimitCheckRequestAck_message_t", propOrder = {
    "reqPty",
    "pty",
    "reltdPtyDetl",
    "instrmt",
...
public class PartyRiskLimitCheckRequestAckMessageT
