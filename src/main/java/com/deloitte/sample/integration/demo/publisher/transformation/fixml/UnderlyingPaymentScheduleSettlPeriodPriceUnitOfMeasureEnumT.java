...
/**
 * <p>Java class for UnderlyingPaymentScheduleSettlPeriodPriceUnitOfMeasure_enum_t.
 * 
...
public enum UnderlyingPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT {
    ...
    public static UnderlyingPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT fromValue(String v) {
        for (UnderlyingPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT c: UnderlyingPaymentScheduleSettlPeriodPriceUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
