...
/**
 * <p>Java class for PaymentStreamReferenceLevelUnitOfMeasure_enum_t.
 * 
...
public enum PaymentStreamReferenceLevelUnitOfMeasureEnumT {
    ...
    public static PaymentStreamReferenceLevelUnitOfMeasureEnumT fromValue(String v) {
        for (PaymentStreamReferenceLevelUnitOfMeasureEnumT c: PaymentStreamReferenceLevelUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
