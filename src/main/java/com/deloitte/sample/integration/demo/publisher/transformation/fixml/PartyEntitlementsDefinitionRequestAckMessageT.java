...
/**
 * PartyEntitlementsDefinitionRequestAck can be found in Volume 3 of the
 * 						specification
 * 
...
@XmlType(name = "PartyEntitlementsDefinitionRequestAck_message_t", propOrder = {
    "reqPty",
    "ptyEntlmntAck"
})
public class PartyEntitlementsDefinitionRequestAckMessageT
    extends AbstractMessageT
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the ptyEntlmntAck property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PartyEntitlementAckGrpBlockT }
     * 
     * 
     */
