...
/**
 * <p>Java class for LegPaymentScheduleRateUnitOfMeasure_enum_t.
 * 
...
public enum LegPaymentScheduleRateUnitOfMeasureEnumT {
    ...
    public static LegPaymentScheduleRateUnitOfMeasureEnumT fromValue(String v) {
        for (LegPaymentScheduleRateUnitOfMeasureEnumT c: LegPaymentScheduleRateUnitOfMeasureEnumT.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
