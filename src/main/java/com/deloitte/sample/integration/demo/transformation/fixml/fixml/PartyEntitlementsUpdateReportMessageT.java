...
/**
 * PartyEntitlementsUpdateReport can be found in Volume 3 of the
 * 						specification
 * 
...
@XmlType(name = "PartyEntitlementsUpdateReport_message_t", propOrder = {
    "applSeqCtrl",
    "reqPty",
    "ptyEntlmntUpd"
})
public class PartyEntitlementsUpdateReportMessageT
